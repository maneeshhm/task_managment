...
Route::get('/customertaskview','CustomerController@viewTask')->name('customer.viewTask');


//contact 
Route::get('/contact','ContactController@contactForm')->name('contact.contactform');
Route::post('/inqurie','ContactController@sendinqurie')->name('contact.inqurie');
Route::get('/viewinqurie','ContactController@viewinqurie')->name('contact.viewinqurie');


//task routes 

Route::get('/viewtask','TaskController@view')->name('task.viewTask');
Route::get('/createtask','TaskController@create')->name('task.create');
Route::post('/storetask','TaskController@store')->name('task.store');
Route::get('/updatetask/{id}','TaskController@edit')->name('task.edit');
Route::delete('/deletetask/{id}','TaskController@destroy')->name('task.destroy');
...
// //new shop ................
// Route::get('/newshop','ToolsController@show');
