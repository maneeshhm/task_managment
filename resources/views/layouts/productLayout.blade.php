    ...
    <div class="container">
        <div class="row mb-4">
            <div class="col-md-12 col-sm*12">
                ...
                <h5 name="tool_id">Tool id : {{ $tool->id }} </h5>
            </div>
        </div>
        <div class="row">
            <div class="col-md-6 col-sm-12">
                <img src="{{ asset('uploads/tools/' . $tool->image) }}" width="400px;" height="400px;" alt="image">
            </div>
            <div class="col-md-6 col-sm-12">
                <form action="{{ route('place.order') }}" method="POST">
                    ...
                    <table>
                        <tr> 
                            ...
                            <td>
                                <p name="tool_price">Rs {{ $tool->tool_price }}</p>
                                <p><input type="hidden" name="tool_price" value="{{ $tool->tool_price }}"></p>
